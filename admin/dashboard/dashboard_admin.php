...
<head>
  ...
  <title>Dashboard</title>
    ...
    <link rel="stylesheet" href="style/dashboard_admin-style.css">
</head>
...
<div class="container"> <!-- Entire form container -->
    ...
    <div class="dashboard-container">
        ...
        <!-- === Card: Create a Subject === -->
        <a href="/mtbmalsysfinal/admin/create-subject/Admin_AddSubject.php" class="dashboard-card-link">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <p><strong>Create a new subject for your school and assign an educator to manage it.</strong></p>
                    <p>This subject becomes a virtual classroom where your chosen educator can upload modules and assessments for students to learn from.</p>
                </div>
            </div>
        </a>

        <!-- === Card: Manage User Accounts === -->
        <a href="/mtbmalsysfinal/admin/manage-user-accounts/main-manage/Admin_ManageUsers.php" class="dashboard-card-link">
            <div class="dashboard-card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <p><strong>Manage all the student and educator accounts in your school.</strong></p>
        ...
        <!-- === Card: View Subjects === -->
        <a href="/mtbmalsysfinal/admin/view-subjects/admin_subject-view.php" class="dashboard-card-link">
            <div class="dashboard-card">
                <div class="card-header">
                    <h2>View Subjects</h2>
                    <span class="icon">📚</span>
                ...
                <div class="card-body">
                    <p><strong>See all the subjects created under your school.</strong></p>
                    <p>You’ll be able to view which educators are assigned, check enrolled students, and manage the subject details easily.</p>
                </div>
            </div>
        </a>

    </div> <!-- End of Dashboard Cards Section -->
