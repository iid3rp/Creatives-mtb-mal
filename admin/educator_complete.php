...
if (!isset($_SESSION['new_educator_refno'])) {
    header("Location: welcome_admin.php");
    exit();
}
$adminFirstName = $_SESSION['firstName'];
$educatorRef = $_SESSION['new_educator_refno'];
$educatorRefFormatted = "ED-" . htmlspecialchars($educatorRef);
unset($_SESSION['new_educator_refno']);
?>
      ...
      <div class="column">
        <div class="registration-box">
          ...
          <div class="input-group">
            ...
            <input type="text" readonly value="<?php echo $educatorRefFormatted; ?>" class="reference-input">
          </div>
