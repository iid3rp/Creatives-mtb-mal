...
<div class="main-content"> <!-- Main content wrapper -->
    ...
    <span>Manage MTB-MLE Subjects</span> 
        <div class="profile-container" onclick="toggleDropdown2()">
    <div class="profile-circle"></div>
    <div class="profile-name"><?php echo htmlspecialchars($adminName); ?></div>
    <div id="dropdown-arrow2" class="dropdown-arrow2 down"></div>
    <div id="profile-dropdown-menu" class="profile-dropdown hidden">
      <a href="admin_view_profile.php"><div class="dropdown-item">View Profile</div>
...
<!-- Container -->
<div class="container">
    <!-- === Manage Subject Cards Section === -->
    <div class="manage-user-container">

        <!-- Card: Create New Subject Account -->
        <div class="user-card" onclick="location.href='add_mtbsubject.php';">
            <div class="card-icon">➕</div>
            <div class="card-text">Add New Subject</div>
        </div>


        <!-- Card: Manage Existing Accounts -->
        <div class="user-card" onclick="location.href='view_subjects.php';">
            <div class="card-icon">📚</div>
            <div class="card-text">View MTB-MLE Subjects</div>
        </div>
